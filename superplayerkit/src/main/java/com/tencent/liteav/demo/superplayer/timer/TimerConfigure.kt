package com.tencent.liteav.demo.superplayer.timer
...
//            },Toast.LENGTH_SHORT)
    ...
    fun changePlayMode(context: Context) {
        if (repeatMode ==   REPEAT_MODE_ONE){
            setRepeatMode(context, REPEAT_MODE_ALL)
        }else{
            setRepeatMode(context, REPEAT_MODE_ONE)
        }
    }
...
//            setTimeType(item, context,position)
//            dialog.dismissBottomSheet()
//        }
//        dialog.showBottomSheet()
//    }

    fun setTimeType(item: TimeType, context: Context,position:Int) {
