...
import com.tencent.liteav.demo.superplayer.SuperPlayerDef.PlayerMode
import com.tencent.liteav.demo.superplayer.SuperPlayerGlobalConfig.Singleton.instance
import com.tencent.liteav.demo.superplayer.SuperPlayerGlobalConfig.TXRect
...
class FloatPlayer : AbsPlayer, View.OnClickListener {
    ...
    private fun updateViewPosition() {
        ...
        val rect: TXRect = instance.floatViewRect
        if (rect != null) {
            rect.x = x
            rect.y = y
        }
