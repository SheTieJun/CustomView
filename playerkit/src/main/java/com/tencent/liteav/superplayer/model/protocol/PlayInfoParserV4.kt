...
import com.tencent.liteav.superplayer.model.entity.*
import com.tencent.liteav.superplayer.model.protocol.PlayInfoConstant.EncryptedURLType
    ...
    override val uRL: String?
        get() {
            ...
            if (!TextUtils.isEmpty(mToken)) {
                url = getEncryptedURL(EncryptedURLType.SIMPLEAES)
            }
            return url
        }
