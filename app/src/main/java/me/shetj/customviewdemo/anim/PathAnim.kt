...
object PathAnim {
    fun showPathAnim(context: Context) {
        ...
        createDialog(context, R.layout.layou_path_anim) {
            ...
            path.quadTo(ArmsUtils.dip2px(100f).toFloat(),ArmsUtils.dip2px(70f).toFloat(),
            ...
            path.quadTo(ArmsUtils.dip2px(100f).toFloat(),ArmsUtils.dip2px(320f).toFloat(),
                ArmsUtils.dip2px(140f).toFloat(), ArmsUtils.dip2px(180f).toFloat())

            path.quadTo(ArmsUtils.dip2px(140f).toFloat(), ArmsUtils.dip2px(140f).toFloat(),
            ...
            path.quadTo(ArmsUtils.dip2px(100f).toFloat(), ArmsUtils.dip2px(50f).toFloat(),
            ...
            val animator = ObjectAnimator.ofFloat(imageView, "x", "y", path)
