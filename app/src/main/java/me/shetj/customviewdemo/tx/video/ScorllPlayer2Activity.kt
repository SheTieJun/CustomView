...
import me.shetj.customviewdemo.databinding.ActivityScorllPlayer2Binding
import me.shetj.customviewdemo.databinding.ActivityScorllPlayerBinding

class ScorllPlayer2Activity : BaseBindingActivity<BaseViewModel,ActivityScorllPlayer2Binding>() {

    override fun initViewBinding(): ActivityScorllPlayer2Binding {
       return ActivityScorllPlayer2Binding.inflate(layoutInflater)
    }
...
//                fullScreencall(this@ScorllPlayer2Activity)
//            }
//
