package me.shetj.customviewdemo.page;
...
public class MeetingPageLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        Timber.i( "Item onLayoutChildren");
        Timber.i( "Item onLayoutChildren isPreLayout = " + state.isPreLayout());
        Timber.i( "Item onLayoutChildren isMeasuring = " + state.isMeasuring());
        Timber.i( "Item onLayoutChildren state = " + state);
...
//        }
    ...
    private void recycleAndFillItems(RecyclerView.Recycler recycler, RecyclerView.State state,
        ...
        Timber.i( "mOffsetX = " + mOffsetX);
        Timber.i( "mOffsetY = " + mOffsetY);
        ...
        Timber.i( "child count = " + getChildCount());
        startPos = pageIndex * mOnePageSize;
        stopPos = startPos + mOnePageSize - 1;
        if (stopPos >= getItemCount()) {
            stopPos = getItemCount() - 1;
        }
        Timber.i( "visible from " + startPos + " to " + stopPos);
        if (mPageListener != null) {
...
//        }
    ...
    public void onScrollStateChanged(int state) {
        Timber.i( "onScrollStateChanged = " + state);
        mScrollState = state;
    ...
    private Rect getItemFrameByPosition(int pos) {
        ...
        if (null == rect) {
            ...
            // 状态输出，用于调试
            Timber.i( "pagePos = " + pagePos);
            Timber.i( "行 = " + row);
            Timber.i( "列 = " + col);

            Timber.i( "offsetX = " + offsetX);
            Timber.i( "offsetY = " + offsetY);
    ...
    private int getPageIndexByOffset() {
        ...
        Timber.i( "getPageIndexByOffset pageIndex = " + pageIndex);
        return pageIndex;
    }
    ...
    int findNextPageFirstPos() {
        ...
        Timber.i( "computeScrollVectorForPosition next = " + page);
    ...
    int findPrePageFirstPos() {
        ...
        int page = mLastPageIndex;
        page--;
        Timber.i( "computeScrollVectorForPosition pre = " + page);
        if (page < 0) {
            page = 0;
        }
        Timber.i( "computeScrollVectorForPosition pre = " + page);
    ...
    private void setPageIndex(int pageIndex, boolean isScrolling) {
        Timber.i( "setPageIndex = " + pageIndex + ":" + isScrolling);
    ...
    public void scrollToPage(int pageIndex) {
        ...
        Timber.i( "mTargetOffsetXBy = " + mTargetOffsetXBy);
        Timber.i( "mTargetOffsetYBy = " + mTargetOffsetYBy);
